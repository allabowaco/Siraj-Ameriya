...
// 1. الدالة المحدثة لتحديث كروت العمولات الكلية
function updateCommissionCards(companyTotal, userTotal) {
    const container = document.getElementById('commissionKpis');
    if (!container) return;
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-6">
                <div class="card border-0 shadow-sm bg-success bg-opacity-10 border-start border-success border-5">
                    <div class="card-body">
                        <small class="text-success fw-bold">مجموع عمولات الشركة الكلي</small>
            ...
            <div class="col-md-6">
                <div class="card border-0 shadow-sm bg-primary bg-opacity-10 border-start border-primary border-5">
                    <div class="card-body">
                        <small class="text-primary fw-bold">مجموع عمولات الزبائن الكلي</small>
                        <h3 class="m-0 fw-bold text-primary">
                            ${formatNumber(userTotal)} د.ع
                        </h3>
                    </div>
                </div>
            </div>
